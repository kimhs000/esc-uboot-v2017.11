...
#define ENV_DEFAULT_ETH_ADDR         "00:0D:15:00:D1:75"
#define ENV_DEFAULT_CLIENT_IP        "192.168.0.150"
#define ENV_DEFAULT_SERVER_IP        "192.168.0.1"
#define ENV_DEFAULT_NETMASK          "255.255.255.0"
#define ENV_DEFAULT_NFSROOT          "/home/khs/nfs"
#define ENV_DEFAULT_TFTP_DIR         "imx6"

#define CONFIG_EXTRA_ENV_SETTINGS \
	"tftp_dir=" ENV_DEFAULT_TFTP_DIR "\0" \
	"script=boot.scr\0" \
	"image=zImage\0" \
	"fdt_file=imx6q-esc.dtb\0" \
	"fdt_addr=0x18000000\0" \
	"boot_fdt=try\0" \
	"ip_dyn=yes\0" \
	"nfsroot=" ENV_DEFAULT_NFSROOT "\0" \
	...
	"findfdt="\
		"if test $fdt_file = undefined; then " \
			"if test $board_name = iMX6-ESC && test $board_rev = MX6Q; then " \
				"setenv fdt_file imx6q-esc.dtb; fi; " \
			"if test $board_name = iMX6-ESC && test $board_rev = MX6DL; then " \
				"setenv fdt_file imx6dl-esc.dtb; fi; " \
			"if test $fdt_file = undefined; then " \
